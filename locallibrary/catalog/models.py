...
class BookInstance(models.Model):
    ...
    status = models.CharField(max_length=1, choices=LOAN_STATUS, blank=True, default='m', help_text='Book aviliablety')
    ...
    class Meta:
        ordering = ["due_back"]
        permissions = (("show_borrowed_list", "List of Borrowed Books"),)
